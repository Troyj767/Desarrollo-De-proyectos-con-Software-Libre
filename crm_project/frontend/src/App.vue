<template>
  <div id="app">
    <!-- Si no está autenticado, solo muestra el router (LoginView) -->
...
// Recargar urgentes al cambiar de ruta
watch(() => route.path, () => {
  if (autenticado.value) cargarUrgentes()
})
</script>
...
.nav-item.router-link-active { background: rgba(255,255,255,.18); color: white;
