...
class UsuarioAdmin(admin.ModelAdmin):
    list_display   = ['id_usuario', 'nombre', 'correo', 'id_rol', 'activo', 'fecha_creacion']
    list_filter    = ['id_rol', 'activo']
    search_fields  = ['nombre', 'correo']
    readonly_fields = ['fecha_creacion', 'fecha_actualizacion']
    # Excluir hash de contraseña del detalle para no exponerlo
    exclude        = ['contrasena_hash']


@admin.register(Contacto)
class ContactoAdmin(admin.ModelAdmin):
    list_display  = ['id_contacto', 'nombre', 'empresa', 'pais', 'estado', 'id_agente_asignado']
...
class InteraccionAdmin(admin.ModelAdmin):
    list_display  = ['id_interaccion', 'id_contacto', 'id_usuario', 'tipo_interaccion', 'fecha_hora']
...
class OportunidadAdmin(admin.ModelAdmin):
    list_display  = ['id_oportunidad', 'titulo', 'id_contacto', 'etapa',
...
class TareaAdmin(admin.ModelAdmin):
    list_display  = ['id_tarea', 'titulo', 'estado', 'prioridad',
